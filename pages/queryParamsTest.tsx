...
import { useRouterQuery } from '../utils/queryParams'
...
export default function Test() {
  ...
  return (
    <>
      <button onClick={() => addURLQueryParam(router, 'hi1', 'test')}>
        add key 1
      </button>
      <button onClick={() => addURLQueryParam(router, 'hi2', 'test')}>
        add key 2
      </button>
      <button onClick={() => addURLQueryParam(router, 'hi3', 'test')}>
        add key 3
      </button>
      <button onClick={() => addURLQueryParam(router, 'hi4', 'test')}>
        add key 4
      </button>
      <button onClick={() => addURLQueryParam(router, 'hi5', 'test')}>
        add key 5
      </button>

      <button onClick={() => removeURLQueryParam(router, 'hi1')}>
        delete key 1
      </button>
      <button onClick={() => removeURLQueryParam(router, 'hi2')}>
        delete key 2
      </button>
      <button onClick={() => removeURLQueryParam(router, 'hi3')}>
        delete key 3
      </button>
    </>
  )
